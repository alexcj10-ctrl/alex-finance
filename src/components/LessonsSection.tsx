...
export function LessonsSection({ activePhase, lessons }: LessonsSectionProps) {
  ...
  return (
    <section className="lessons-section mt-6" aria-labelledby="lessons-title">
      <header className="lessons-header">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
            Guarda, riconosci la situazione e porta in campo un’idea alla volta.
          </p>
        </div>
