...
const phaseOrder = Object.keys(phases) as PhaseId[];
const formationOrder = Object.keys(formations) as FormationId[];
...
export default function Home() {
      ...
      modelContext.registerTool(
        {
          ...
          description:
            'Imposta la fase e il sistema di gioco mostrati nella lavagna di ESORDIENTI ANALYST.',
          inputSchema: {
            type: 'object',
            properties: {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="page-width flex h-16 items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-black tracking-[-0.02em]">ESORDIENTI ANALYST</p>
          ...
          <div className="flex items-center gap-3">
            <span className="hidden items-center gap-2 text-xs font-medium text-muted-foreground sm:flex">
              <span className="status-dot" /> Area tecnica attiva
            </span>
      ...
      <div className="page-width pb-12 pt-8 lg:pt-11">
        <section className="mb-7 grid items-end gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div>
            <div className="mb-3 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-accent-foreground/70">
              <Sparkles className="size-3.5 text-primary" /> Percorso tecnico U13
            </div>
            <h1 className="max-w-3xl text-balance text-4xl font-black leading-[0.97] tracking-[-0.055em] sm:text-5xl lg:text-[3.6rem]">
              Leggi il gioco. <span className="text-primary">Allena la scelta.</span>
            </h1>
          </div>
          <p className="max-w-xl text-sm leading-6 text-muted-foreground lg:pb-1">
            Una lavagna operativa per allenatori: scegli il sistema, osserva le relazioni e porta in campo un focus chiaro.
          </p>
        </section>
        ...
        <div className="workspace-grid">
              ...
              <fieldset className="formation-picker" aria-label="Scegli il sistema di gioco">
                {formationOrder.map((formationId) => (
                  <button
                    ...
                    onClick={() => setActiveFormation(formationId)}
                  >
          ...
          <section className="analysis-panel" aria-labelledby="phase-title">
            ...
            <div className="objective-box mt-5">
              ...
              <div>
                <p className="text-[10px] font-extrabold uppercase tracking-[0.16em] text-primary">Obiettivo</p>
